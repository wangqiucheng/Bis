        ...
        <div class="container pl-0 pr-0 pos-r">
            <div class="col-sm-8 pt-30 pl-20 pr-10 mb-20">
                <div class="clear mt-20 full-w bg-white pt-40 pb-35 pr-15">
                    <div class="clear col-sm-2 pl-0 pr-0">
                        <img class="img-70 pull-right" src="<%=request.getContextPath() %>/resources/img/user/Appraise/appraise-portraitv1.png" alt="">
                    </div>
                    <div class="clear col-sm-10 pl-20 pr-20">
                        <p class="line-h-20 mb-20 clear">
                            <input type="hidden" class="appraisesuccess-state" value="1">
                            <span class="col-8d665a f-18 pull-left dis-ib">游先生</span>
                        ...
                        <p class="full-w mb-25">
                            <span class="f-14 col-b0b0b0">2017年9月19日</span>
                        </p>
                        <p class="f-14 col-333 line-h-20">
                            用了觉得非常棒，我要买1000个！！！！</br>为什么会有这么好用的东西呢？？？</br>棒呆！</br> 鼎力推荐！</br>快买啊！！
                        </p>
                    </div>
                </div>
                <div class="clear mt-20 full-w h-50 line-h-50 text-center f-14 col-309DE2 bg-white cur-p">
                    加载更多
                </div>
            </div>
            <!-- 一下4个浮标嵌入的数据一致 -->
            ...
            <div class="col-sm-4 pt-50 pl-20 pr-20 visible-sm visible-md">
                <div class="clear bg-white text-center pt-40 pb-40">
                    <div class="clear pl-40 pr-40">
                        <a href="">
                            <img class="full-w" src="<%=request.getContextPath() %>/resources/img/user/Appraise/appraisetipsv2.png" alt="">
                        </a>
                    </div>
                    <p class="mt-30 f-20-16-ipad col-333 text-center">
                        <a class="col-333 t-nonehove hovecol-333" href="">HC3A250悉心心电记录仪</a>
                    </p>
                    <p class="mt-10 f-20-16-ipad col-309DE2 text-center">
                        1180元
                    </p>
                    <div class="clear mt-40 text-center pl-30 pr-30">
                        <button class="h-40-30-ipad full-w text-center line-h-40-30-ipad col-white bg-309DE2 bor-none hovbg-2D90CF f-14-12-ipad">
                            了解详情
                        </button>
                    </div>
                </div>
            ...
            <div class="poa-a mt-50 pl-20 pr-20 w-400 z-99 ml-800 hidden-sm hidden-md posa-appraiselist-righttop">
                <div class="clear bg-white h-500 text-center pt-60">
                    <a href="">
                        <img class="img-200" src="<%=request.getContextPath() %>/resources/img/user/Appraise/appraisetipsv2.png" alt="">
                    </a>
