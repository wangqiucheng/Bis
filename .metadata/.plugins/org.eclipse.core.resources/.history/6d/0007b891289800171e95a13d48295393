...
public class CartController {
	...
	public String addCart(HttpServletRequest request,Model model) throws Exception{
		...
		if("1".equals(serviceId) || "0".equals(issingleorcombo)) {
			...
			Cart cart3=ICartService.getCart(serviceId);
			if(cart2==null) {
				cart2=new Cart();
			...
			//	cart.setTotal(commodity.getPrice()*1.0);
				...
				if(cart3==null) {
					cart3=new Cart();
					Commodity commo=iCommodityService.getcommodity(serviceId);
