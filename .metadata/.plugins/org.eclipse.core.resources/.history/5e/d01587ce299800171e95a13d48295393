                ...
                <div class="clear full-w ">
                    <div class="clear col-sm-5 pl-0 pr-0 pull-left">
                        <div class="claer col-md-12 pull-left text-center pd-50-30-ipad">
                            <img id="prode-zoom-main" class="full-w produ-max-show " src="<%=request.getContextPath() %>/resources/${commodity.pic1_picture}" data-zoom-image="<%=request.getContextPath() %>/resources/${commodity.pic1_picture}" alt="">
                        </div>
                        <div class="clear col-md-12 mtb-20-5-ipad pl-0 pr-0 pull-left">
                            <div class="prode-zoom-img clear dis-ib cur-p col-sm-3 plr-10-5-ipad prode-zoom-img-v1" data-image="<%=request.getContextPath() %>/resources/${commodity.pic1_picture}" data-zoom-image="<%=request.getContextPath() %>/resources/${commodity.pic1_picture}">
                                <img class="full-w bor bor-col-B2B2B2 bor-col-309DE2 produ-min-tips " src="<%=request.getContextPath() %>/resources/${commodity.pic1_picture}" />
                            </div>
                            <div class="prode-zoom-img clear dis-ib cur-p col-sm-3 plr-10-5-ipad 
                            prode-zoom-img-v2" data-image="<%=request.getContextPath() %>/resources/${commodity.pic2_picture}" data-zoom-image="<%=request.getContextPath() %>/resources/${commodity.pic2_picture}">
                                <img class="full-w bor bor-col-B2B2B2 produ-min-tips" src="<%=request.getContextPath() %>/resources/${commodity.pic2_picture}" />
                            </div>
                            <div class="prode-zoom-img clear dis-ib cur-p col-sm-3 plr-10-5-ipad prode-zoom-img-v3" data-image="<%=request.getContextPath() %>/resources/${commodity.pic3_picture}" data-zoom-image="<%=request.getContextPath() %>/resources/${commodity.pic3_picture}">
                                <img class="full-w bor bor-col-B2B2B2 produ-min-tips" src="<%=request.getContextPath() %>/resources/${commodity.pic3_picture}" />
                            </div>
                            <div class="prode-zoom-img clear dis-ib cur-p col-sm-3 plr-10-5-ipad prode-zoom-img-v4" data-image="<%=request.getContextPath() %>/resources/${commodity.pic4_picture}" data-zoom-image="<%=request.getContextPath() %>/resources/${commodity.pic4_picture}">
                                <img class="full-w bor bor-col-B2B2B2 produ-min-tips" src="<%=request.getContextPath() %>/resources/${commodity.pic4_picture}" />
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="clear full-w bor bor-col-B2B2B2 cur-p shieldframe mb-20">
                                    ...
                                    <div class="clear col-md-7 col-sm-8 pull-left pt-30-10-ipad pl-0 pr-0">
                                        <div class="clear pull-left col-sm-2 pl-0 pr-0">
                                            <img class="pos-r t--2-6-ipad" src="<%=request.getContextPath() %>/resources/${comm.pic1_picture}" alt="">
                                        </div>
                                        <div class="clear pull-left col-sm-10 pl-5 pr-0">
                                            <p class="col-black f-18-14-ipad family-h line-h-25-30-ipad">
                                                ...
                                                <span class="col-309DE2 f-12 hidden-sm">
                                                	<a href="<%=request.getContextPath() %>/shopping/getCommodityId?shop_number=${comm.shop_number}">了解服务详情</a>
                                            </span>
                                            </p>
                        ...
                        <div class="clear ptb-20-10-ipad bor bor-l-none bor-r-none bor-col-B2B2B2">
                          <!-- 这里是需要提交的相关信息 -->
                            ...
                            <div class="clear col-sm-8 pl-0 pr-10">
                                <button class="line-h-45-30-ipad h-45-30-ipad col-white f-18-14-ipad text-center full-w radius-0 bg-309DE2 bor-none hovbg-2D90CF" onclick="add_shop();">加入购物车</button>
                            </div>
                            <div class="clear col-sm-4 pl-10 pr-0">
                                <button class="line-h-45-30-ipad h-45-30-ipad col-white f-18-14-ipad text-center full-w radius-0 bg-9BD2F4 bor-none hovbg-9BD2F4" onclick="">立即购买</button>
                            </div>
                        </div>
                    ...
                    <div class="clear col-sm-2 pull-left pt-20 pl-10 pr-10">
                        ...
                        <div class="clear pos-r bor bor-col-B2B2B2 pull-left mt-10 mb-10 cur-p">
                            ...
                            <div class="clear h-25 line-h-25 rgba-d2d2d2-20 pos-a b-0 l-0 pl-10 pr-10 full-w hidden-sm hidden-md">
                                <span class="col-727272 t-nonehove hovecol-309DE2" href="">${listproduct.sub_description}</span>
                            </div>
                        </div>
						</c:forEach>
