...
public class Package {
	...
	public Package(int id, String package_number, String package_name, String patitle, String sub_descrition,
			Double price, int product_id, int orderId, String main_picture, String pic1_picture, String pic2_picuture,
			String pic3_picuture, String pic4_picuture, Date insert_time, Date update_time) {
		super();
		this.id = id;
		this.package_number = package_number;
		this.package_name = package_name;
